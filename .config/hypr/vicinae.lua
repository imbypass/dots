...
hl.bind("SUPER + V", hl.dsp.exec_cmd("vicinae vicinae://extensions/vicinae/clipboard/history"), { dont_inhibit = true, description = "Show clipboard history" })

-- Emoji Picker
-- TODO: manual review — 'unbind = SUPER, Period'. In Lua, capture the result of hl.bind(...) and call :remove(). See hl.meta.lua.
hl.bind("SUPER + Period", hl.dsp.exec_cmd("vicinae vicinae://extensions/vicinae/core/search-emojis"), { dont_inhibit = true, description = "Show emoji picker" })

-- Window Picker
-- TODO: manual review — 'unbind = SUPER, Escape'. In Lua, capture the result of hl.bind(...) and call :remove(). See hl.meta.lua.
hl.bind("SUPER + Escape", hl.dsp.exec_cmd("vicinae vicinae://extensions/vicinae/wm/switch-windows"), { dont_inhibit = true, description = "Switch windows" })
...
hl.bind("SUPER + ALT + J", hl.dsp.exec_cmd("vicinae vicinae://extensions/ozer-01/aria2-manager/index"), { dont_inhibit = true, description = "Open Download Manager" })
