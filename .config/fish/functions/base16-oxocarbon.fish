...
function base16-oxocarbon -d Oxocarbon
    set color00 12/12/12 # Base 00 - Black
    set color01 D3/4D/55 # Base 08 - Red
    set color02 42/be/65 # Base 0B - Green
    set color03 ff/dc/7b # Base 0A - Yellow
    set color04 33/b1/ff # Base 0D - Blue
    set color05 ee/53/96 # Base 0E - Magenta
    set color06 3d/db/d9 # Base 0C - Cyan
    set color07 DC/DF/E0 # Base 05 - White
