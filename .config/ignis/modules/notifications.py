...
class Popup(widgets.Box):
    def __init__(
        ...
        widget.css_classes = ["notification-popup", "urgency-" + str(notification.urgency)]
        self._inner = widgets.Revealer(transition_type="slide_up", child=widget)
    ...
    def destroy(self):
        ...
        self._inner.transition_type = "slide_up"
